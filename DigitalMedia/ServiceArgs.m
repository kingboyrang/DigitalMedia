...
static NSString *defaultWebServiceURL=@"";
static NSString *defaultWebServiceNameSpaces=defaultWebServiceNameSpace;
...
{
    if (defaultWebServiceNameSpaces!=space) {
        [defaultWebServiceNameSpaces release];
        defaultWebServiceNameSpaces=[space retain];
    }
}
-(id)init{
    if (self=[super init]) {
...
-(NSString*)serviceNameSpace{
    ...
    return defaultWebServiceNameSpaces;
}
